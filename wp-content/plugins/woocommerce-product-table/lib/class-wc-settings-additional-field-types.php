...
if ( ! class_exists( 'WC_Settings_Additional_Field_Types' ) ) {
    ...
    class WC_Settings_Additional_Field_Types {
        ...
        public static function register_settings() {
            foreach ( array( 'color_size', 'help_note', 'hidden', 'multi_text', 'settings_start', 'settings_end', 'plugin_promo' ) as $field ) {
        ...
        public static function color_size_field( $value ) {
            ...
            <tr valign="top">
                ...
                <td class="forminp forminp-<?php echo sanitize_title( $value['type'] ) ?> color-size-field">&lrm;
