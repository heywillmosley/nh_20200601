...
use Barn2\WPT_Lib\Registerable,
    Barn2\WPT_Lib\Util,
    Barn2\WPT_Lib\Plugin\License\EDD_Licensing,
    Barn2\WPT_Lib\Plugin\License\Plugin_License,
    Barn2\WPT_Lib\Plugin\Admin\Plugin_Updater,
    Barn2\WPT_Lib\Plugin\License\Admin\License_Key_Setting,
    Barn2\WPT_Lib\Plugin\License\Admin\License_Notices,
    Barn2\WPT_Lib\Plugin\License\License_Checker;
...
class Premium_Plugin extends Simple_Plugin implements Registerable, Licensed_Plugin {
    ...
    public function __construct( array $data ) {
        ...
        $this->services['license_setting'] = new License_Key_Setting( $this->get_license(), $this->is_woocommerce() );
