...
final class WCPT_Util {
    ...
    public static function get_product_name( $product ) {
        //@todo: Is this function still needed or does WooCommerce correctly handle variation names?
        if ( ! $product ) {
            return '';
        }
        ...
        if ( 'variation' === $product->get_type() ) {
            ...
            $parent_name = WCPT_Util::get_parent( $product )->get_name();
     ...
     *
     * @param WC_Product $product The product.
     * @return WC_Product The parent product or false.
     */
    ...
    public static function get_asset_url( $path = '' ) {
        return plugins_url( 'assets/' . ltrim( $path, '/' ), \Barn2\Plugin\WC_Product_Table\PLUGIN_FILE );
    }
    ...
    public static function get_template_path() {
        return plugin_dir_path( \Barn2\Plugin\WC_Product_Table\PLUGIN_FILE ) . 'templates/';
    }
    ...
    public static function is_wc_active() {
        _deprecated_function( __FUNCTION__, '2.6', 'Barn2\\WPT_Lib\\Util::is_woocommerce_active()' );
        return Util::is_woocommerce_active();
    }
    ...
    public static function is_wc_ppc_active() {
        _deprecated_function( __FUNCTION__, '2.6', 'Barn2\\WPT_Lib\\Util::is_protected_categories_active()' );
        return Util::is_protected_categories_active();
    }

    public static function is_quick_view_pro_active() {
        _deprecated_function( __FUNCTION__, '2.6', 'Barn2\\WPT_Lib\\Util::is_quick_view_pro_active()' );
        return Util::is_quick_view_pro_active();
    }
