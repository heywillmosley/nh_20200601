...
class Frontend_Scripts implements Registerable, Service {
    ...
    public function load_scripts() {
        ...
        \add_action( 'wp_enqueue_scripts', array( $this, 'register_styles' ), 15 ); // after WooCommerce load_scripts()
        \add_action( 'wp_enqueue_scripts', array( $this, 'register_scripts' ), 15 ); // after WooCommerce load_scripts()
        \add_filter( 'wc_product_table_multi_cart_button', array( $this, 'set_add_selected_to_cart_text' ), 5 );
    }
    ...
    public function register_styles() {
        ...
        // WCPT styles
        \wp_register_style( 'jquery-data-tables', \WCPT_Util::get_asset_url( "css/datatables/datatables.min.css" ), array(), '1.10.20' );
        \wp_register_style( self::SCRIPT_HANDLE, \WCPT_Util::get_asset_url( "css/wc-product-table{$suffix}.css" ), array( 'jquery-data-tables' ), $this->script_version );
    ...
    public function register_scripts() {
        ...
        // WCPT scripts
        \wp_register_script( 'jquery-data-tables', \WCPT_Util::get_asset_url( "js/datatables/datatables.min.js" ), array( 'jquery' ), '1.10.20', true );
        ...
        \wp_register_script( 'jquery-serialize-object-macek', \WCPT_Util::get_asset_url( "js/jquery-serialize-object/jquery.serialize-object.min.js" ), array(
            'jquery' ), '2.5', true );
        ...
        \wp_register_script( self::SCRIPT_HANDLE, \WCPT_Util::get_asset_url( "js/wc-product-table{$suffix}.js" ), array( 'jquery-data-tables', 'jquery-blockui',
            'jquery-serialize-object-macek' ), $this->script_version, true );
    ...
    public function set_add_selected_to_cart_text( $text ) {
