...
#add_action( 'init', create_function( '', 'global $zendesk_support; $zendesk_support = new Zendesk_Support();' ) ); #WM Patch 20200810

add_action("init", function(){ global $zendesk_support; $zendesk_support = new Zendesk_Support(); });
